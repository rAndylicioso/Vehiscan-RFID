...
<aside id="sidebar" class="sidebar-transition sidebar-open fixed left-0 top-0 h-screen flex flex-col border-r bg-white text-gray-900 overflow-x-hidden z-40" role="navigation" aria-label="Main navigation">
  ...
  <div class="flex-1 overflow-y-auto py-2">
    <div class="mb-4 px-3">
      ...
      <div class="space-y-1">
        <a href="../admin_panel.php" class="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-all text-gray-700 hover:bg-gray-100">
        ...
        <a href="../admin_panel.php#manage" class="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-all text-gray-700 hover:bg-gray-100">
          <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="../admin_panel.php#logs" class="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-all text-gray-700 hover:bg-gray-100">
          <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="../admin_panel.php#audit" class="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-all text-gray-700 hover:bg-gray-100">
          <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="employee_list.php" class="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-all bg-gray-200 text-gray-900 font-medium">
          <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="../admin_panel.php#simulator" class="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-all text-gray-700 hover:bg-gray-100">
          <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="px-3">
      ...
      <div class="space-y-1">
        <a href="../admin_panel.php#backup" class="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-all text-gray-700 hover:bg-gray-100">
          <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
